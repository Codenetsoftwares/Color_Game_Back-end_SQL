...
export const createSlider = async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .send(apiResponseSuccess(insertedSliders, true, statusCode.create, 'Slider created successfully.'));
  } catch (error) {
    res
...
export const activeSlider = async (req, res) => {
  ...
  try {
    ...
    return res.status(statusCode.success).send(apiResponseSuccess(sliderData, true, statusCode.success, 'success'));
  } catch (error) {
    return res
      .status(statusCode.internalServerError)
      .send(
...
export const updateSliderImage = async (req, res) => {
  ...
  try {
    ...
    return res.status(statusCode.success).send(apiResponseSuccess(updatedSlider, true, statusCode.success, 'success'));
  } catch (error) {
    return res
      .status(statusCode.internalServerError)
      .send(
...
export const createGif = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(statusCode.create)
      .send(apiResponseSuccess(insertedData, true, statusCode.create, 'Create Gif Successfully'));
  } catch (error) {
    return res
      .status(statusCode.internalServerError)
      .send(
