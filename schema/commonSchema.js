...
export const currentOrderSchema = [param('marketId').exists().withMessage('Market ID is required.')];
...
export const trashUserSchema = [body('userId').notEmpty().withMessage('User ID is required.')];
...
export const createdMarketSchema = [
  ...
  body('participants')
    ...
    .isInt({ min: 1 })
    .withMessage('Participants must be a positive integer'),
...
export const createdRunnerSchema = [
  ...
  body('runners')
    .isArray()
    .withMessage('Runners must be an array')
    .notEmpty()
    .withMessage('Runners array cannot be empty'),
];

export const createdRateSchema = [
  param('runnerId').notEmpty().withMessage('Runner ID is required'),
  body('back').optional().isNumeric().withMessage('Back rate must be a numeric value'),
  body('lay').optional().isNumeric().withMessage('Lay rate must be a numeric value'),
];
...
export const updateGameSchema = [
  ...
  body('gameName').optional().notEmpty().withMessage('Game name cannot be empty'),
...
export const updateRunnerSchema = [
  body('runnerId').notEmpty().withMessage('Runner ID is required'),
  body('runnerName').optional().notEmpty().withMessage('Runner name cannot be empty'),
];
...
export const announcementsSchema = [
  body('typeOfAnnouncement').notEmpty().withMessage('Type of announcement is required'),
  body('announcement').notEmpty().withMessage('Announcement content is required'),
];

export const updateAnnouncementSchema = [
  param('announceId').notEmpty().withMessage('Announcement ID is required'),
  body('typeOfAnnouncement').optional().notEmpty().withMessage('Type of announcement is required'),
  body('announcement').optional().notEmpty().withMessage('Announcement content is required'),
];
...
export const eligibilityCheckValidationRules = [
  body('eligibilityCheck').isBoolean().withMessage('Eligibility check must be a boolean value'),
];
...
export const validateGameId = [param('gameId').notEmpty().withMessage('Game ID cannot be empty')];
...
export const validateDeleteRunner = [param('runnerId').notEmpty().withMessage('Runner ID is required')];

export const calculateProfitLossSchema = [param('userName').notEmpty().withMessage('Username is required')];
...
export const gameActiveInactiveValidate = [
  ...
  body('gameId').notEmpty().withMessage('Game Id is required.').isUUID(4).withMessage('Game Id is not a valid.'),
];
...
export const marketProfitLossValidate = [param('gameId').notEmpty().withMessage('Game ID is required')];

export const runnerProfitLossValidate = [param('marketId').notEmpty().withMessage('Market ID is required')];
...
export const validatePurchaseLotteryTicket = [
  body('lotteryId').isUUID().withMessage('Invalid lottery ID. It must be a valid UUID.'),
];
